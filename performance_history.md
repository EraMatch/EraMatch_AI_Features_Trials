...
| **2c** | Hyper-Turbo 2 | 6.34m | Parallel Fetch. Concurrent key-file content retrieval. | Best |
| **2d** | Ultimate Turbo| 7.23m | Early Break. as_completed + Mastery Break logic. | Regressed |
| **2e** | Lightning Turbo| 9.91m | Parallel Search. 3x parallel LLM Pillar calls. | Regression |
...
### Trial 2e: Lightning Parallelism (Current / main)
...
Based on Trial 2c and 2e results, sequential Pillar Search (Phase 1) is faster for cloud APIs than parallel chunks, likely due to internal load balancing.
